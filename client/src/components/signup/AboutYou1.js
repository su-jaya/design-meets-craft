...
class AboutYou1 extends Component {
  ...
  submitHandler = (event) => {
    ...
    axios.post("http://localhost:5000/signup/aboutyou1", this.state)
    .then( () => {
      this.setState({
        youinasentence: "",
        position: "",
  ...
  render() {
    return (
      <div>
        <h2>Hello - name - </h2>
        <p>
          Tell us some details about you so that the others can get to know you
          and your work better. You can always change your information later in
          your profile
        </p>
        ...
        <form onSubmit={(event) => this.submitHandler(event)}>
          ...
          <select id="language" onChange={(event) => this.changeHandler(event)} value={this.state.language}>
